...
- [ ] Ограничение глубины обхода, задержки между запросами и пользовательский User-Agent
- [ ] Повторные попытки запросов и пул воркеров для ускорения краулинга
- [ ] Сбор SEO-метрик: title, meta description и наличие h1
- [ ] Проверка внутренних и внешних ссылок с фиксацией битых URL
